...
Potentially problematic to implement as the multiplier can span more pipeline stages than regular ALUs.
...
NOTE: assembly will stay messy with this anyway, especially when number of used register needs to be kept low
...
last custom 2 op
f3 { bits: 3, name: 0b011 },  101
f7 { bits: 5, name: 0b01 011 },
