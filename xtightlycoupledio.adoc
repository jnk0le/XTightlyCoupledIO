...
Has an optional "side-set" operiation and delay which stall execution of any following instruction.
...
NOTE: Square bracket was selected as MIPS syntax inherited by RISC-V doesn't use square brackets.
...
2:
	...
	tio.bnei.xi t0, (RCC_CFGR_SWS_PLL >> RCC_CFGR_SWS_Pos), 2b
	ret
```
...
init_clocks2():
	...
	tio.bnei.xi a0, (RCC_CFGR_SWS_PLL >> RCC_CFGR_SWS_Pos), 2f
...
5:
	tio.bfextracti a0, RCC_CFGR, RCC_CFGR_SWS_Pos, 2
	tio.bnei.xi a0, (RCC_CFGR_SWS_PLL >> RCC_CFGR_SWS_Pos), 5b
	ret
```
