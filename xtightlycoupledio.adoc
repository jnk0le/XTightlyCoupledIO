...
| total cycles (possible)  | 34(32) | 35 | 30(27)
| non IIR loads/stores     | 2 | 4(2 pcrel) | 0
| cycles to PWM (possible) | 14(11) | 18(15) | 11(8)
|====
...
ADC1_IRQHandler():
	...
	fmul.s a2, a1, x4 // a2 not required if PWM write can be deffered
	fcvt.w.s a2, a2
	tio.max HRTIM1_TIMA_CMP1xR, a2, zero
	tio.bseti ADC1_ISR, zero, ADC_ISR_JEOC_Pos // can also tio.addi
	fmadd.s x20, a0, x29, x21
	fmadd.s x21, a0, x30, x22
	fmul.s x22, a0, x31 // a0 no longer needed, can do the PWM here
...
13 instructions total, 5 to pwm (8 at lower reg pressure)
