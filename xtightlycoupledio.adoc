...
```
tio.sbseti3.yy y11, y11, 13 // set 13th bit in 11th io register in bank 3
tio.sbseti2.yx y22, zero, 17 // write (1<<17) to 22nd io register in bank 2
```
...
```
tio.sbseti io108, io108, 13 // set 13th bit in 11th io register in bank 3
tio.sbseti io87, zero, 17 // write (1<<17) to 22nd io register in bank 2
```
