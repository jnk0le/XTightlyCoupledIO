...
.LBB0_2:
        ...
        sh2add  a2, a1, a2
        lw      a2, 0(a2)
        lui     a3, %hi(jnk0le::sseg::CommonConfig<true, 1207960576u, 2u, 3u, 4u, 5u>::column_pin_mask_lut)
        addi    a3, a3, %lo(jnk0le::sseg::CommonConfig<true, 1207960576u, 2u, 3u, 4u, 5u>::column_pin_mask_lut)
        sh1add  a1, a1, a3
        lhu     a1, 0(a1)
        sw      a2, 24(a0)
        sw      a1, 1064(a0)
...
.L3:
        ...
        .word   1207960576
        .word   .LANCHOR0
        .word   jnk0le::sseg::CommonConfig<true, 1207960576u, 2ul, 3ul, 4ul, 5ul>::column_pin_mask_lut
```
...
```
	...
	tio.addi GPIOB_BSRR, zero, 0x3c // pins 2,3,4,5
	lui a0, %hi(displ)
	addi a0, a0, %lo(displ)
	lw a1, 16(a0) // get cnt
	c.bnez a1, 1f
...
1:
	...
	lui a0 %hi(column_pin_mask_lut)
	addi a0 %lo(column_pin_mask_lut)
	sh1add a0, a1, a0 
	lh a0, 0(a0)
