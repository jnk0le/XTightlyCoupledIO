...
|====================================================================================
| Version | Change
| v3.2.31 | added floating point 3p3z control loop
...
NOTE: interrupt overhead is out of scope of Xtighlycoupledio, therefore only a C function is analysed.
See <<xteic>> for further irq latency analysis.

magic numbers and overall design according to <<an5305>> that provides following assumptions:

- Vref set by DAC on the differential ADC, or subtraction handled by ADC
- ADC handles sign extension
- timer saturates the output to maximum duty (no neg to zero saturation)
...
the conversion can be interrupted by injected channels. (and injected channels 
...
ADC1_IRQHandler():
	...
	flw     ft3,4(a5)
	flw     fa4,32(a5)
	fmadd.s fa5,fa5,ft1,fa3
	flw     fa1,8(a5)
	flw     ft5,36(a5)
	flw     fa0,12(a5)
	flw     fa2,40(a5)
	fmadd.s fa4,ft3,fa4,fa5
	flw     ft0,16(a5)
	flw     fa3,44(a5)
	flw     fa5,20(a5)
	flw     ft4,48(a5)
	fmadd.s fa1,fa1,ft5,fa4
	flw     fa4,52(a5)
	li      a4,1073836032
	fmadd.s fa2,fa0,fa2,fa1
	fmadd.s fa3,ft0,fa3,fa2
	fmadd.s fa5,fa5,ft4,fa3
	fmul.s  fa4,fa5,fa4
	fcvt.w.s a3,fa4,rtz
	max     a3,a3,zero
	sw      a3,-1892(a4)
...
NOTE: on CM4 those loads could be done by one big vldm. All FMAs here are 3 cycle anyway
