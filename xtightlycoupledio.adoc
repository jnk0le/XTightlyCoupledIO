...
The 8051 frequently comes with peripherals mapped in XRAM address space which is even less eficient to access.
...
Accumulator `A` is also bit-addressable SFR.
