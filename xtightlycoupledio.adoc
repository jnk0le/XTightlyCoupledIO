...
- apply gain factor (K) to the numerator coefficients instead of applying it separatly. (FP)
...
| total cycles (possible)  | 32(30) | 33 | 28(25)
| non filter loads/stores  | 2 | 4(2 pcrel) | 0
| cycles to PWM (possible) | 12(10) | 16(13) | 9(6)
|====
...
ADC1_IRQHandler():
	...
	fcvt.w.s a2, a1 // a2 not required if PWM write can be deffered
