...
(16bit + 6bit offset from instr). Provides AMO-ALU instruction as well as integer to float conversions.
...
samples from c2000 related documents <<c2000workshop>>
...
10 bytes and 5 cycles

risc-v + XTightlyCoupledIO::
[source, asm]
```
tio.cm.bseti TIMER0TCR, 4
tio.bseti TIMER0TPRD32, zero, 16
tio.cm.bclri TIMER0TCR, 4
```
