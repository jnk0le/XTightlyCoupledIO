...
init_clocks():
	...
	tio.bseti RCC_CR, RCC_CR_PLLON_Pos
1:
	tio.bsbclri RCC_CR1, RCC_CR_PLLRDY_Pos, 1b
	tio.bseti RCC_CFGR, RCC_CFGR_SW_PLL_Pos+1 // effectively 0b10
...
init_7seg():
	...
	tio.bseti GPIOB_MODER, GPIO_MODER_MODER1_Pos // '0' bit doesn't matter in oring
	c.li t0, (0b01 << GPIO_MODER_MODER0_Pos) | (0b01 << GPIO_MODER_MODER1_Pos)
	tio.or GPIOF_MODER, t0
	tio.bseti GPIOA_MODER, GPIO_MODER_MODER9_Pos // '0' bit doesn't matter in oring
	...
	lui t0, %hi(0b01010101010101)
	tio.addi GPIOA_MODER, t0, %lo(0b01010101010101)
	c.li t0, -1
	tio.srli GPIOA_OSPEEDR, t0, 16
	tio.bseti RCC_APB2ENR, RCC_APB2ENR_TIM16EN_Pos
	...
	lui t0, %hi(47999)
	tio.addi TIM16_ARR, zero, %lo(47999)
