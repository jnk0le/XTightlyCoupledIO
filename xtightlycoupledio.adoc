...
However `csr` registers are generally used to modify core architectural behaviour and thus perform execute than expected.
...
For more efficient efficient use of IO register space available by certain instructions.
